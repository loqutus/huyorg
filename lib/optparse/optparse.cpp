    ...
    : desc("Options:")
{
    ...
    desc.add_options()(
        "host",
        boost::program_options::value(&host)->default_value(std::string("::1")),
        "master host")(
        "port",
        boost::program_options::value(&port)->default_value(std::string("9999")),
        "master port")("json", boost::program_options::value(&config),
        "json to upload");
