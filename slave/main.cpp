...
int main(int argc, char** argv)
{
    ...
    while (true) {
        ...
        if (action == "run_container") {
            ...
            std::string container_id = container_server.run_container(container_image, container_command);
            ...
            auto container_destroy_answer = container_server.destroy_container(container_id);
